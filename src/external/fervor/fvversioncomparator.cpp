...
FvVersionComparator::CharacterType FvVersionComparator::TypeOfCharacter(const std::string& character)
{
	if (character == ".") {
...
std::vector<std::string> FvVersionComparator::SplitVersionString(const std::string& version)
{
...
FvVersionComparator::ComparatorResult FvVersionComparator::CompareVersions(const std::string& versionA,
