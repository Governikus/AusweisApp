...
void WorkflowAuthenticateQtGui::activate()
{
	...
	connect(mContext.data(), &WorkflowContext::fireCurrentStateChanged, this, &WorkflowAuthenticateQtGui::onCurrentStateChanged);
}
...
void WorkflowAuthenticateQtGui::onCurrentStateChanged(const QString& pNewState)
{
