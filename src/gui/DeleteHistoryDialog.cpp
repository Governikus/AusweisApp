	...
	: QDialog(pParent)
{
	...
	setWindowTitle(QCoreApplication::applicationName() + " - " + tr("Delete history"));
	...
	mComboBox->addItem(tr("Past hour"), (int) TimePeriod::PAST_HOUR);
	mComboBox->addItem(tr("Past day"), (int) TimePeriod::PAST_DAY);
	mComboBox->addItem(tr("Past week"), (int) TimePeriod::PAST_WEEK);
	mComboBox->addItem(tr("Last four weeks"), (int) TimePeriod::LAST_FOUR_WEEKS);
	mComboBox->addItem(tr("All history"), (int) TimePeriod::ALL_HISTORY);
