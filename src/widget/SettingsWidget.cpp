	...
	, mSettingsChanged(false)
{
	...
	connect(mUi->pinTab, &PinSettingsWidget::firePinButtonEnabledUpdated, this, &SettingsWidget::onUpdateButtonState);
	connect(mUi->pinTab, &PinSettingsWidget::firePinButtonEnabledUpdated, this, &SettingsWidget::onUpdateApplyButtonText);
...
void SettingsWidget::switchToGuiModule(GuiModule pModule)
{
	switch (pModule)
	{
		...
		case GuiModule::DEVICE_SETTINGS:
			mUi->settingsTabWidget->setCurrentWidget(mUi->readerDeviceTab);
			break;
	}
}
