...
ResultErrorView {
	...
	//: MOBILE Success message that the Smart-eID was created.
	...
	ColumnLayout {
		...
		GText {
			//: MOBILE Explanation text of the Smart-eID blocking code
		...
		GText {
			...
			//: MOBILE Placeholder (error) text if the Smart-eID setup finished successfully but for some reason no blocking code was retrieved
