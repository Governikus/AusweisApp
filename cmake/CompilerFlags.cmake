option(USE_LEGACY_OPENSSL_API "Enable legacy API (1.1.1) of openssl" OFF)
if(USE_LEGACY_OPENSSL_API)
	add_definitions(-DUSE_LEGACY_OPENSSL_API)
endif()
...
if(LIBS_GOVERNIKUS)
	add_definitions(-DLIBS_GOVERNIKUS)
	version_to_hex(STRICT_UP_TO "${LIBS_QT}")
else()
	version_to_hex(STRICT_UP_TO "${MIN_QT_VERSION}")
endif()
add_definitions(-DQT_ENABLE_STRICT_MODE_UP_TO=${STRICT_UP_TO})
message(STATUS "QT_ENABLE_STRICT_MODE_UP_TO: ${STRICT_UP_TO}")
...
if(NOT DEFINED CMAKE_COMPILE_WARNING_AS_ERROR AND VENDOR_GOVERNIKUS AND NOT USE_LEGACY_OPENSSL_API)
...
if(MSVC)
	...
	set(PREFER_LD mold CACHE STRING "")
	set(FALLBACK_LD -fuse-ld=lld)
