if(MAC OR LINUX OR WIN32)
	...
	if(IS_BETA_VERSION)
		set(APPCAST_NOTES_URL ${APPCAST_URL}/beta)
	else()
		set(APPCAST_NOTES_URL ${APPCAST_URL})
	endif()
	...
	macro(ADD_APPCAST_FILE _files _system _min)
		...
		foreach(filePath ${_files})
			...
			string(REPLACE "APPCAST_NOTES" "${APPCAST_NOTES_URL}/ReleaseNotes.html#${APPCAST_FILE_VERSION}" item ${item})
