		...
		TutorialContent {
			...
			Column {
				...
				Text {
					...
					text: qsTr("Install AusweisApp2 on both your device without NFC <b>and</b> your android smartphone with NFC ability.") + settingsModel.translationTrigger
					font.family: "Noto Serif"
			...
			Column {
				...
				Text {
					anchors.horizontalCenter: parent.horizontalCenter
					width: parent.width * 0.9
					text: qsTr("Now enter \"Smartphone as card reader\" in the app on your android smartphone <b>with</b>...") + settingsModel.translationTrigger
					font.family: "Noto Serif"
					font.pixelSize: Constants.tutorial_content_header_h1_font_size
					horizontalAlignment: Text.AlignHCenter
					wrapMode: Text.WordWrap
			...
			Column {
				...
				Text {
					anchors.horizontalCenter: parent.horizontalCenter
					width: parent.width * 0.9
					text: qsTr("Now open the app on your device <b>without</b> NFC and select <b>Smartphone as card reader</b>.") + settingsModel.translationTrigger
					font.family: "Noto Serif"
					font.pixelSize: Constants.tutorial_content_header_h1_font_size
					horizontalAlignment: Text.AlignHCenter
					wrapMode: Text.WordWrap
