...
CheckResultSuggestionView {
	...
	SuggestionData {
		...
		title: qsTr("No NFC")
		//: LABEL ANDROID IOS
		text: qsTr("Your mobile device has no NFC interface. This is required to read the ID card. However, you can use a separate smartphone as card reader to utilize the online identification function.<br><br>You can find smartphones compatible with the %1 on our website.")
	...
	SuggestionData {
		...
		//: LABEL ANDROID IOS
		text: qsTr("The NFC interface of your mobile device does not support Extended Length communication and cannot be used to read the ID card. Unfortunately, the %1 has no influence on this restriction.<br><br>You can find smartphones compatible with the %1 on our website.")
			.arg(Qt.application.name)
		//: LABEL ANDROID IOS
		continueButtonText: qsTr("Open website")
		continueButtonIcon: "qrc:///images/material_open_in_new.svg"
