...
Item {
	...
	readonly property int header_font_size: Utils.sp(40)
	readonly property int normal_font_size: Utils.sp(29)
	readonly property int label_font_size: Utils.sp(25)
	readonly property int small_font_size: Utils.sp(22)
