...
step(${CMAKE_COMMAND} -E tar cfJ ../${ARTIFACT_FILENAME}-ReleaseNotes.tar.xz . CHDIR ${T_BUILD_DIR}/docs/notes)

step(${T_TARGET} sdk)
step(${T_TARGET} sdk.latex.pdf)
step(${CMAKE_COMMAND} -E tar cfJ ../${ARTIFACT_FILENAME}-SDK.tar.xz . CHDIR ${T_BUILD_DIR}/docs/sdk/html)
