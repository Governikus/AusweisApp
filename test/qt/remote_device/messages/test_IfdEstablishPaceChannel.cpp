	...
	: public QObject
{
	...
	private Q_SLOTS:
		...
		void values()
		{
			...
			QCOMPARE(ifdEstablishPaceChannel.getPreferredPinLength(), 6);
		}
		...
		void toJson()
		{
			...
			QCOMPARE(obj.value(QLatin1String("PreferredPinLength")).toInt(), version >= IfdVersion::Version::v2 ? 6 : 0);
		}
		...
		void wrongTypes()
		{
			...
			const QByteArray message(R"({
										"ContextHandle": "TestContext",
										"InputData": 1,
										"PreferredPinLength": "Hello World!",
										"SlotHandle": 2,
										"msg": "IFDEstablishPACEChannel"
									 })");
			...
			QCOMPARE(ifdEstablishPaceChannel.getInputData(), EstablishPaceChannel());
			QCOMPARE(ifdEstablishPaceChannel.getPreferredPinLength(), 0);
			...
			QVERIFY(TestFileHelper::containsLog(logSpy, QLatin1String("The value of \"PreferredPinLength\" should be of type \"number\"")));
		}
		...
		void preferredPinLength()
		{
			...
			QCOMPARE(ifdEstablishPaceChannel.getPreferredPinLength(), preferredPinLength);
		}
