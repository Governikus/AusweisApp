	...
	: public QObject
{
	...
	private Q_SLOTS:
		...
		void escapedMapping()
		{
			...
			QCOMPARE(HelpAction::getInstance().getHelpUrl("provider"), "file://" + padding + helpDir.path() + "/de/provider.html");
		}
		...
		void contextMap()
		{
			...
			QCOMPARE(HelpAction::getInstance().getContextMapping("pinManagement"), QString("pin-management.html"));
...
QTEST_GUILESS_MAIN(test_HelpAction)
